...
public class ObjectRenderer {
  ...
  // Shader names.
  private static final String VERTEX_SHADER_NAME = "shaders/vertex/object.vs";
  private static final String FRAGMENT_SHADER_NAME = "shaders/fragment/object.ps";
